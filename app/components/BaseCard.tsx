...
export default function BaseCard({ children, title, image }: BaseCardProps) {
    return (
        <div className="flex flex-col items-center justify-center p-2 border-2 border-blue-100 w-80 rounded-lg shadow-lg my-2 mx-auto hover:cursor-pointer hover:bg-blue-200">
