  ...
  return (
    <section className="max-w-full mx-auto px-10 pt-28 pb-28">
      ...
      <motion.h1
        ...
        className="text-[clamp(2.8rem,6vw,4.5rem)] font-semibold leading-[1.08] tracking-[-0.02em] mb-6 max-w-full"
      >
      ...
      <motion.p
        ...
        className="text-lg text-muted max-w-1/2 mb-10 leading-relaxed"
      >
      ...
      <motion.div
        ...
        className="mt-16 bg-surface border border-border rounded-xl p-6 max-w-1/2 font-mono text-[13px] leading-[1.9]"
      >
        <div className="flex gap-2 mb-4 pb-4 border-b border-border">
          <span className="w-3 h-3 rounded-full bg-[#ef4444]" />
          <span className="w-3 h-3 rounded-full bg-[#f59e0b]" />
          <span className="w-3 h-3 rounded-full bg-[#22c55e]" />
          <span className="text-[12px] text-[#3a4060] ml-2">kastidev.ts</span>
        </div>
        <div>
          <span className="text-[#3a4060] mr-6 select-none">1</span>
          <span className="text-cyan">const</span> <span className="text-text">kastidev</span> = {'{'}
        </div>
        <div>
          <span className="text-[#3a4060] mr-6 select-none">2</span>
          &nbsp;&nbsp;role: <span className="text-[#86efac]">&quot;Fullstack Developer&quot;</span>,
        </div>
        <div>
          <span className="text-[#3a4060] mr-6 select-none">3</span>
        ...
        <div>
          <span className="text-[#3a4060] mr-6 select-none">4</span>
        ...
        <div>
          <span className="text-[#3a4060] mr-6 select-none">5</span>
          &nbsp;&nbsp;mobile: [<span className="text-[#86efac]">&quot;React Native&quot;</span>, <span className="text-[#86efac]">&quot;Android&quot;</span>],
        </div>
        <div>
          <span className="text-[#3a4060] mr-6 select-none">6</span>
